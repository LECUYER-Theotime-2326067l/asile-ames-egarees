...
public class Elf extends Creature implements Death, Wait, Demoralise {
...
//    }
    ...
    public void die() {
        ...
        MedicalService.getAllCreatures();
        for(int i=0; i<=3; i++){
...
//    }
    ...
    @Override
    public void waiting() {
        super.setMoralIndicator(getMoralIndicator()-10);
    }

    @Override
    public void demoraliseAllCreatures() {
        for(Creature creature : MedicalService.getAllCreatures()){
            this.setMoralIndicator(creature.getMoralIndicator()-2);
        }
    }
}
